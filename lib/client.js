    ...
    function DupguardSection(props) {
      ...
      return React.createElement('div', { className: 'dg-section' },
        ...
        React.createElement('div', { className: 'dg-add' },
          ...
          React.createElement('button', { className: 'dg-btn', onClick: add }, t('add')),
